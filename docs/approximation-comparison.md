...
| 1.0 | 1.5 | 0.3 | 0.30 | 1.429 | 1.707 | 0.001 | 1.716 | +0.58% | 1.698 | −0.50% | 1.736 |
| 1.0 | 1.5 | 0.6 | 0.60 | 2.500 | 2.767 | 0.001 | 2.799 | +1.16% | 2.776 | +0.34% | 2.842 |
| 1.0 | 1.5 | 0.9 | 0.90 | 10.000 | 10.120 | 0.024 | 10.194 | +0.73% | 10.325 | +2.03% | 10.238 |
| 1.0 | 2.0 | 0.3 | 0.30 | 1.429 | 1.583 | 0.001 | 1.591 | +0.45% | 1.595 | +0.76% | 1.600 |
| 1.0 | 2.0 | 0.6 | 0.60 | 2.500 | 2.623 | 0.001 | 2.641 | +0.67% | 2.667 | +1.67% | 2.659 |
| 1.0 | 2.0 | 0.9 | 0.90 | 10.000 | 10.028 | 0.024 | 10.063 | +0.35% | 10.170 | +1.42% | 10.076 |
| 1.0 | 3.0 | 0.6 | 0.60 | 2.500 | 2.547 | 0.001 | 2.554 | +0.25% | 2.583 | +1.41% | 2.560 |
| 1.0 | 5.0 | 0.6 | 0.60 | 2.500 | 2.515 | 0.001 | 2.517 | +0.07% | 2.533 | +0.71% | 2.519 |

### 7.2 Key Observations

**Homogeneous case** (μ₁ = μ₂ = 1.0): Both T_UL and T_LH recover Nelson-Tantawi exactly; residual errors (≤ 0.15%) are simulation noise shrinking toward zero with more jobs.

**T_UL**: Consistently small positive errors (≤ 1.16%); always within bounds; best at high heterogeneity.

**T_LH** (β=10): Exact for homogeneous case; worst case +2.03% at r=1.5, heavy load; errors ≤ 1.67% for r ≥ 2.
